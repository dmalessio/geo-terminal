...
with s3:
    if st.button("SUCCESSIVA", key="next_soc", use_container_width=True) and st.session_state.page_socmint < total_p_soc - 1: st.session_state.page_socmint += 1; st.rerun()import streamlit as st
import yfinance as yf
import feedparser
import requests
import re
