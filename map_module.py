...
def render_strategic_map(selected_area, active_layers, selected_countries=None):
    ...
    st.pydeck_chart(pdk.Deck(layers=layers, initial_view_state=pdk.ViewState(latitude=v["lat"], longitude=v["lon"], zoom=v["zoom"], pitch=45), map_style="dark", tooltip={"html": "{tooltip_text}", "style": {"backgroundColor": "#050505", "color": "#f3f4f6", "border": "1px solid #1f2937"}}))